...
<main class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-md mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden p-6 mb-6">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4">
                    ...
                    <p class="mt-1 text-xs text-gray-500">Password must be at least 8 characters long and include a
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <label class="relative flex items-center p-4 border rounded-lg cursor-pointer"
                            ...
                            <input type="radio" name="account_type" value="user" class="sr-only"
                                x-model="selectedType" {{ old('account_type') == 'user' ? 'checked' : '' }}>
                        ...
                        <label class="relative flex items-center p-4 border rounded-lg cursor-pointer"
                            ...
                            <input type="radio" name="account_type" value="provider" class="sr-only"
                                x-model="selectedType" {{ old('account_type') == 'provider' ? 'checked' : '' }}>
                        ...
                        <label class="relative flex items-center p-4 border rounded-lg cursor-pointer"
                            ...
                            <input type="radio" name="account_type" value="admin" class="sr-only"
                                x-model="selectedType" {{ old('account_type') == 'admin' ? 'checked' : '' }}>
                ...
                <div class="mb-6">
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="terms" name="terms_condition" type="checkbox"
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-medium text-gray-700">I agree to the <a href="#"
                                    ...
                                    href="#" class="text-indigo-600 hover:text-indigo-500">Privacy
                                    Policy</a></label>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden p-6">
            ...
            <p class="text-gray-600 mb-4">If you're having trouble signing up or have questions about our services, our
