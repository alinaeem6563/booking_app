        ...
        <div class="container mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8 relative z-10">
            <div class="max-w-3xl">
                ...
                <p class="mt-6 text-xl max-w-2xl">
                    Find and book the best service providers in your area. From home services to personal care, we've got you covered.
                </p>
                <div class="mt-10 flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="#" class="inline-flex items-center justify-center px-5 py-3 border border-white text-base font-medium rounded-md text-white hover:bg-indigo-500">
                        Become a Provider
                    </a>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-4">
                    <form class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="location" id="location" placeholder="Enter your location" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    <div class="relative">
                        <img class="h-48 w-full object-cover" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="Provider profile">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <h3 class="text-lg font-medium text-gray-900">Sarah Anderson</h3>
                        ...
                        <div class="mt-4 border-t border-gray-200 pt-4">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-900">$25/hr</p>
                                </div>
                                <div>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    <div class="relative">
                        <img class="h-48 w-full object-cover" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="Provider profile">
                        <div class="absolute top-0 right-0 m-2">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <h3 class="text-lg font-medium text-gray-900">John Davis</h3>
                        ...
                        <div class="mt-4">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-500">94 reviews</span>
                            </div>
                        </div>
                        <div class="mt-4 border-t border-gray-200 pt-4">
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-sm text-gray-500">Starting from</p>
                                    <p class="text-lg font-semibold text-gray-900">$40/hr</p>
                                </div>
                                <div>
                                    <span class="inline-flex rounded-md shadow-sm">
                                        <a href="#" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    <div class="relative">
                        <img class="h-48 w-full object-cover" src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="Provider profile">
                        <div class="absolute top-0 right-0 m-2">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                Available Today
                            </span>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <h3 class="text-lg font-medium text-gray-900">Emma Johnson</h3>
                                <p class="text-sm text-gray-500">Massage Therapist</p>
                            </div>
                        </div>
                        <div class="mt-4">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-500">156 reviews</span>
                            </div>
                        </div>
                        <div class="mt-4 border-t border-gray-200 pt-4">
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-sm text-gray-500">Starting from</p>
                                    <p class="text-lg font-semibold text-gray-900">$60/hr</p>
                                </div>
                                <div>
                                    <span class="inline-flex rounded-md shadow-sm">
                                        <a href="#" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    <div class="relative">
                        <img class="h-48 w-full object-cover" src="https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="Provider profile">
                        <div class="absolute top-0 right-0 m-2">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-500">203 reviews</span>
                            </div>
                        </div>
                        <div class="mt-4 border-t border-gray-200 pt-4">
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-sm text-gray-500">Starting from</p>
                                    <p class="text-lg font-semibold text-gray-900">$55/hr</p>
                                </div>
                                <div>
                                    <span class="inline-flex rounded-md shadow-sm">
                                        <a href="#" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-gray-100 cursor-not-allowed">
                                            Join Waitlist
                                        </a>
                                    </span>
                                </div>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600">
                        "I was amazed by how easy it was to book a cleaning service. The cleaner arrived on time and did an exceptional job. Will definitely use this platform again!"
                    </p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600">
                        "Had a plumbing emergency and needed someone fast. Found a great plumber through this app who came within the hour. The service was excellent and reasonably priced."
                    </p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600">
                        "I've tried several booking platforms, but this one stands out. The massage therapist I booked was professional and skilled. The whole experience was seamless from booking to payment."
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="mt-8 flex justify-center">
                ...
                <div class="ml-3 inline-flex">
                    <a href="#" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-700 hover:bg-indigo-800">
                        Learn More
                    </a>
                </div>
            </div>
