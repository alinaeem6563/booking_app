        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="col-span-1 md:col-span-1">
                    <div class="flex items-center">
                        <svg class="h-8 w-auto text-indigo-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-span-1">
                    ...
                    <ul class="mt-4 space-y-4">
                        <li>
                            <a href="#" class="text-base text-gray-400 hover:text-white">Home Cleaning</a>
                        </li>
                        <li>
                            <a href="#" class="text-base text-gray-400 hover:text-white">Plumbing</a>
                        </li>
                        <li>
                            <a href="#" class="text-base text-gray-400 hover:text-white">Electrical</a>
                        </li>
                        <li>
                            <a href="#" class="text-base text-gray-400 hover:text-white">Personal Training</a>
                        </li>
                        <li>
                            <a href="#" class="text-base text-gray-400 hover:text-white">Massage Therapy</a>
                        </li>
                    </ul>
                </div>
                <div class="col-span-1">
                ...
                <div class="col-span-1">
                    ...
                    <ul class="mt-4 space-y-4">
                        ...
                        <li>
                            <a href="#" class="text-base text-gray-400 hover:text-white">Accessibility</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="mt-12 border-t border-gray-800 pt-8">
                <p class="text-base text-gray-400 text-center">
                    &copy; 2023 BookEase, Inc. All rights reserved.
                </p>
            </div>
        </div>
    </footer>