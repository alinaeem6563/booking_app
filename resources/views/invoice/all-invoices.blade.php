...
:class="sidebarCollapsed ? 'sidebar-collapsed' : 'sidebar-expanded'">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-8 mb-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {{-- <div>
                    ...
                    <select id="client-filter" class="w-full px-4 py-3 text-sm bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 pb-12">
            <!-- Mobile Card View -->
