            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                <div class="text-center">
                    ...
                    <p class="mt-6 max-w-2xl mx-auto text-xl text-indigo-100">
                        Find the perfect service provider for your needs. Browse our categories and connect with trusted
                        professionals.
                    </p>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" x-data="userCategories()">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="md:col-span-2">
                        <div class="relative">
                            ...
                            <input type="text" x-model="searchTerm" @input="filterCategories()"
                    ...
                    <!-- Sort -->
                    <div>
                        <select x-model="sortBy" @change="sortCategories()"
                    ...
                    <div class="flex items-center justify-end space-x-2">
                        <button @click="viewMode = 'grid'"
                            :class="viewMode === 'grid' ? 'bg-indigo-100 text-indigo-700' :
                        ...
                        <button @click="viewMode = 'list'"
                            :class="viewMode === 'list' ? 'bg-indigo-100 text-indigo-700' :
                                'text-gray-500 hover:text-gray-700'"
                            class="p-2 rounded-md">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mb-6">
                <p class="text-sm text-gray-600">
                    Showing <span x-text="filteredCategories.length"></span> of <span x-text="categories.length"></span>
                    categories
                </p>
            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg hover:border-indigo-300 transition-all duration-300 cursor-pointer group"
                        ...
                        <div class="p-6">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-gray-600 text-sm line-clamp-3 mb-4" x-text="category.category_description">
                                </p>
                ...
                processCategories() {
                    this.categories = this.categories.map(category => {
                        ...
                        if (category.category_icon_link && category.category_icon_link.startsWith('<svg')) {
                            ...
                            category.icon_preview =
                                `<img src="${category.category_icon_link}" alt="Icon" class="h-8 w-8">`;
                        } else {
