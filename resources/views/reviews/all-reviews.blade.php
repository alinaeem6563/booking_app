                ...
                <div class="mb-8">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-600">Manage customer reviews for your services</p>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900" x-text="stats.approved"></dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900" x-text="stats.pending"></dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900" x-text="stats.avgRating"></dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                    ...
                    fetch('/provider/reviews/bulk-delete', {
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                alert('Error deleting reviews. Please try again.');
                            }
                        })
                        .catch(error => {
                            console.error('Error:', error);
