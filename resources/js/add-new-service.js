document.addEventListener("DOMContentLoaded", function () {
    ...
    const offeringsContainer = document.querySelector(
        "#offerings-container .space-y-4"
    );
    ...
    addOfferingBtn?.addEventListener("click", function () {
        ...
        newOffering.className =
            "border border-gray-200 rounded-md p-4 offering-item";
        ...
        deleteBtn?.addEventListener("click", function () {
            ...
            offeringCount--;
            document
                .querySelectorAll(".offering-item")
                .forEach((item, index) => {
                    item.querySelector("h5").textContent = `Offering #${
                        index + 1
                    }`;
                });
        });
    ...
    serviceImageInput?.addEventListener("change", function (e) {
        ...
        if (file) {
            ...
            reader.onload = function (e) {
                const container =
                    serviceImageInput.closest("div.border-dashed");
    ...
    function removeFaqItem(e) {
        ...
        setTimeout(() => {
            ...
            if (faqCount === 1) {
                const firstItemRemoveBtn = faqContainer.querySelector(
                    ".faq-item:first-child .remove-faq"
                );
            ...
            faqContainer
                ...
                .forEach((item, index) => {
                    ...
                    const questionInput = item.querySelector(
                        'input[name^="questions"]'
                    );
                    const answerInput = item.querySelector(
    ...
    faqAddBtn?.addEventListener("click", function () {
        ...
        newItem.className =
            "faq-item mb-6 p-5 border border-gray-200 rounded-lg bg-gray-50 transition-all duration-200 hover:shadow-md animate-fade-in";
        newItem.innerHTML = `
    ...
    const additionalServicesContainer = document.getElementById(
    ...
    addServiceBtn.addEventListener("click", function () {
        const newItem = document.createElement("div");
        newItem.className =
            "additional-service-item bg-gray-50 p-3 rounded-md border border-gray-200 mb-3 animate-fade-in";
        newItem.innerHTML = `
            <div class="flex justify-between items-center mb-2">
