        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex items-center justify-center">
                <ol class="flex items-center w-full max-w-3xl">
                    ...
                    <li class="flex items-center text-indigo-600 font-medium">
                        <span class="flex items-center justify-center w-8 h-8 bg-indigo-600 rounded-full text-white">2</span>
                    ...
                    <li class="flex items-center text-indigo-600 font-medium">
                        <span class="flex items-center justify-center w-8 h-8 bg-indigo-600 rounded-full text-white">3</span>
                ...
                <div class="w-full lg:w-2/3">
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6 p-6">
                        ...
                        <div class="mb-6" x-data="{ paymentMethod: 'card' }">
                            <div class="flex flex-wrap gap-4 mb-6">
                                <label class="relative flex items-center p-4 border rounded-lg cursor-pointer" :class="paymentMethod === 'card' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200'">
                                    <input type="radio" name="payment-method" value="card" class="sr-only" x-model="paymentMethod">
                                    <span class="flex items-center">
                                        <span class="w-5 h-5 mr-4 border rounded-full flex items-center justify-center" :class="paymentMethod === 'card' ? 'border-indigo-600' : 'border-gray-400'">
                                            <span class="w-3 h-3 rounded-full" :class="paymentMethod === 'card' ? 'bg-indigo-600' : ''"></span>
                                        </span>
                                        <svg class="w-8 h-8 mr-3" viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <label class="relative flex items-center p-4 border rounded-lg cursor-pointer" :class="paymentMethod === 'paypal' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200'">
                                    <input type="radio" name="payment-method" value="paypal" class="sr-only" x-model="paymentMethod">
                                    <span class="flex items-center">
                                        <span class="w-5 h-5 mr-4 border rounded-full flex items-center justify-center" :class="paymentMethod === 'paypal' ? 'border-indigo-600' : 'border-gray-400'">
                                            <span class="w-3 h-3 rounded-full" :class="paymentMethod === 'paypal' ? 'bg-indigo-600' : ''"></span>
                                        </span>
                            ...
                            <!-- Credit Card Form -->
                            <div x-show="paymentMethod === 'card'" class="mt-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div class="col-span-2">
                                        <label for="card-number" class="block text-sm font-medium text-gray-700 mb-1">Card Number</label>
                                        <div class="relative">
                                            <input type="text" id="card-number" name="card-number" placeholder="1234 5678 9012 3456" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md pl-10">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="expiry" name="expiry" placeholder="MM/YY" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    
                                    <div>
                                        <label for="cvv" class="block text-sm font-medium text-gray-700 mb-1">CVV</label>
                                        <div class="relative">
                                            <input type="text" id="cvv" name="cvv" placeholder="123" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" id="name-on-card" name="name-on-card" placeholder="John Doe" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                            </div>
                            ...
                            <div x-show="paymentMethod === 'paypal'" class="mt-6 p-4 bg-blue-50 rounded-lg">
                                ...
                                <p class="text-sm text-gray-600">After clicking "Complete Booking", you'll be taken to PayPal to finalize your payment. Once the payment is processed, you'll be returned to BookEase to view your booking confirmation.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="first-name" name="first-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            
                            <div>
                                <label for="last-name" class="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
                                <input type="text" id="last-name" name="last-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="city" name="city" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            
                            <div>
                                <label for="state" class="block text-sm font-medium text-gray-700 mb-1">State / Province</label>
                                <input type="text" id="state" name="state" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            
                            <div>
                                <label for="zip" class="block text-sm font-medium text-gray-700 mb-1">ZIP / Postal Code</label>
                                <input type="text" id="zip" name="zip" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6 p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="notes" name="notes" rows="3" placeholder="Any special requests or information for the service provider?" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                        </div>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="marketing" name="marketing" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="marketing" class="font-medium text-gray-700">Email me about special pricing and updates</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden sticky top-24">
                        <div class="p-6 border-b border-gray-200">
                            ...
                            <div class="text-center mt-4">
                                <a href="#" class="text-sm text-gray-600 hover:text-indigo-600">Cancel and return to provider</a>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-gray-50">
                            ...
                            <a href="#" class="text-sm text-indigo-600 hover:text-indigo-500 font-medium">Contact Support</a>
                        </div>
                    </div>
                </div>
            </div>
